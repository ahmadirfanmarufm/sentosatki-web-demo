...
const RegistrationForm = ({ handleCheckboxChange, isCheckboxChecked }) => {
    ...
    const uniqueCountries = [...new Set(jobs.map(job => job.location))];
    const sectorsByCountry = jobs
        .filter(job => job.location === selectedCountry)
        .map(job => job.sector);
    const uniqueSectors = [...new Set(sectorsByCountry)];

    const positionsBySector = jobs
        .filter(job => job.location === selectedCountry && job.sector === selectedSector)
                    ...
                    <div className="mx-auto max-w-8xl lg:text-center">
                        ...
                        <div className="relative p-6 flex-auto">
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                <h1 className='font-semibold text-center py-4 text-primary-secondary-800 uppercase'>Formulir Biodata</h1>
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="no_nik_tki">
                                            NIK / No. KTP <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="number"
                                            id="no_nik_tki"
                                    ...
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="nama_tki">
                                            Nama Lengkap <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="nama_tki"
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="kelamin_tki">
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="agama_tki">
                                ...
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="tmplahir_tki">
                                            Tempat Lahir <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="tmplahir_tki"
                                    ...
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="tgllahir_tki">
                                            Tanggal Lahir <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="date"
                                            id="tgllahir_tki"
                                ...
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="tgibdn_tki">
                                            Tinggi Badan <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <select
                                            id="tgibdn_tki"
                                            name="tgibdn_tki"
                                    ...
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="brtbdn_tki">
                                ...
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="pendidikan_tki">
                                            Pendidikan Terakhir <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <select
                                            id="pendidikan_tki"
                                            name="pendidikan_tki"
                                    ...
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="luluss_tki">
                                            Tahun Kelulusan <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <select
                                            id="luluss_tki"
                                            name="luluss_tki"
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="stskawin_tki">
                                ...
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="alamat_tki">
                                        ...
                                        >
                                            ...
                                            {provinces.map(prov => (
                                                <option key={prov.province_id} value={prov.province_id}>{toPascalCase(prov.province_name)}</option>
                                            ))}
                                        </select>
                                        <select
                                            id="kab_kota" 
                                        ...
                                        >
                                            ...
                                            {cities.map(city => (
                                                <option key={city.city_id} value={city.city_id}>{toPascalCase(city.city_name)}</option>
                                            ))}
                                        </select>
                                        <select
                                            id="kecamatan" 
                                        ...
                                        >
                                            ...
                                            {districts.map(district => (
                                                <option key={district.district_id} value={district.district_id}>{toPascalCase(district.district_name)}</option>
                                            ))}
                                        </select>
                                    </div>
                                    <div className="w-full mt-0 sm:mt-auto">
                                        ...
                                        >
                                            ...
                                            {villages.map((village) => (
                                                <option key={village.village_id} value={village.village_name}>{toPascalCase(village.village_name)}</option>
                                            ))}
                                        </select>
                                        <div className='flex flex-col sm:flex-row sm:space-x-4'>
                                            <input
                                ...
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="nohp_tki">
                                            No. Handphone <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="number"
                                            id="nohp_tki"
                                    ...
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="nohp2_tki">
                                            No. Whatsapp <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="number"
                                            id="nohp2_tki"
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="email_tki">
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="filetki">
                                            Pas Foto (Ukuran File Maksimal 1 MB) <span className="text-red-600">*(Wajib)</span>
                                    </label>
                                    {photoError && (
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="TJdaftar_tki">
                                    ...
                                    >
                                        ...
                                        <option value="BR0606240000">BLK LN Tri Tunggal Mandiri</option>
                                        <option value="BR2802240000">LPK LN Bimo Putra Sentosa (BPS)</option>
                                        <option value="BR2601240001">LPK LN Bintang Jaya Mandiri (BJM)</option>
                                        <option value="BR2601240000">LPK LN Dimas Pranata Lampung (DPL)</option>
                                        <option value="BR1302240000">LPK LN Maris Gama Mulya</option>
                                        <option value="BR2601240002">LPK LN Mentari Cahaya Buana (MCB)</option>
                                        <option value="BR1302240001">LPK LN Tali Asih Lampung (TAL)</option>
                                ...
                                <h1 className='font-semibold text-center py-4 text-primary-secondary-800 uppercase'>Tujuan Negara, Sektor, dan Jabatan</h1>
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="ntujuan_tki">
                                                Negara Tujuan <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <select
                                            id="ntujuan_tki"
                                            name="ntujuan_tki"
                                    ...
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="sektor_tki">
                                    ...
                                    <div className='w-full'>
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="jabatan_tki">
                                ...
                                <h1 className='font-semibold text-center py-4 text-primary-secondary-800 uppercase'>Pengalaman Kerja</h1>
                                <div>
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="ntujuan_tki">
                                                Pengalaman Kerja 1 <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="negara1"
                                ...
                                <div>
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="ntujuan_tki">
                                                Pengalaman Kerja 2 <span className="text-gray-500">(Opsional)</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="negara2"
                                ...
                                <div>
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="ntujuan_tki">
                                                Pengalaman Kerja 3 <span className="text-gray-500">(Opsional)</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="negara3"
                                ...
                                <div>
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="ntujuan_tki">
                                                Pengalaman Kerja 4 <span className="text-gray-500">(Opsional)</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="negara4"
                                ...
                                <div>
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="ntujuan_tki">
                                                Pengalaman Kerja 5 <span className="text-gray-500">(Opsional)</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="negara5"
                                ...
                                <div className="py-7">
                                    <p className="text-md text-gray-700 mb-2">
                                        Sesuai <span className='font-semibold text-primary-secondary-800'>Undang-Undang Republik Indonesia Nomor 18 Tahun 2017, Tanggal 22 November 2017</span>, Tentang Perlindungan Pekerja Migran Indonesia <br/>yaitu:
                                    </p>
                                    <p className="text-md text-gray-700 mb-2">
                                        <span className='font-semibold text-primary-secondary-800'>BAB II Pasal 5 (b)</span>: Setiap Pekerja Migran Indonesia yang akan bekerja ke luar negeri harus memenuhi persyaratan memiliki kompetensi.
                                    </p>
                                    <p className="text-md text-gray-700 mb-2">
                                        Apakah Kamu telah memiliki <span className='font-semibold text-primary-secondary-800'>Sertifikat BNSP</span>?
                                    </p>
                                    <p className="text-md text-gray-700 mb-4">
                                        Apabila belum memiliki, silakan daftarkan diri kamu melalui{' '}
                                        <a href="https://lpksentosa.com/home/daftarsiswa" target='_blank' className="text-primary-400 hover:underline">
                                            link ini
                                        </a>, kami akan membantu Kamu.
                                        <br />
                                        Apabila telah memiliki SERTIFIKASI BNSP, silakan kolom di bawah ini:
                                    </p>
                                </div>
                                <h1 className='font-semibold text-center pb-2 text-primary-secondary-800 uppercase'>Biodata Sertifikat BNSP</h1>
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="nama_lpk_bnsp">
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="alamat_lpk_bnsp">
                                ...
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="sertifikasi_bnsp">
                                            No. Sertifikasi BNSP <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="number"
                                            id="sertifikasi_bnsp"
                                    ...
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="jenis_sertifikasi_bnsp">
                                            Jenis Sertifikasi <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="masa_berlaku_bnsp">
                                            Habis Masa Berlaku <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="date"
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="tgl_peng_bnsp">
                                            Tanggal Pengeluaran <span className="text-red-600">*(Wajib)</span>
                                    </label>
                                    <input
                                        type="date"
                                        id="tgl_peng_bnsp"
                                ...
                                <div className="py-7">
                                    ...
                                    <span className='font-semibold text-primary-secondary-800'>BAB II Pasal 5 (c)</span>: Setiap Pekerja Migran Indonesia yang akan bekerja ke luar negeri harus memenuhi persyaratan kesehatan jasmani dan rohani.
                                        <br />
                                        Apakah Kamu sudah melakukan pemeriksaan kesehatan (medikal check-up)? Jika sudah, mohon kolom di bawah ini:
                                    </p>
                                </div>
                                <h1 className='font-semibold text-center pb-2 text-primary-secondary-800 uppercase'>Biodata Medikal Check-up</h1>
                                <div className="flex flex-col sm:flex-row sm:space-x-4">
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="tgl_medikal_mcu">
                                            Tanggal Medikal <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="date"
                                            id="tgl_medikal_mcu"
                                    ...
                                    <div className="w-full mb-4 sm:mb-0">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="hasil_medikal_mcu">
                                            Hasil Medikal <span className="text-red-600">*(Wajib)</span>
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="w-full">
                                        <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="no_blanko_mcu">
                                ...
                                <div>
                                    <label className="block text-left text-gray-800 text-sm font-medium mb-2" htmlFor="nama_rs_klinik_mcu">
                                            Nama RS / Klinik <span className="text-red-600">*(Wajib)</span>
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="py-4">
                                    <div className="flex flex-col items-center justify-center p-6 border-t border-solid border-gray-300 rounded-b">
                                        <label htmlFor="invalidCheck" className="flex items-center cursor-pointer">
                                            <input
                                                type="checkbox"
                                                id="invalidCheck"
                                                name="invalidCheck"
                                            ...
                                            <span className="text-base text-gray-800">
                                                ...
                                                >
                                                    Syarat dan Ketentuan <span className="text-red-600">*</span>
                                                </span>
                                            </span>
                                        </label>
