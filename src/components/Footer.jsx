const FooterSection = () => {
    return(
        <footer className="bg-primary-secondary-800 text-center lg:text-left">
        <div className="flex items-center justify-center border-b-2 border-gray-600 p-6 lg:justify-between">
            <div className="mr-12 hidden lg:block">
                <span className="text-white font-semibold">Cari tau kegiatan kami yang lain di media sosial:</span>
            </div>
            {/* <!-- Social network icons container --> */}
            <div className="flex justify-center">
            <a className="mr-6 text-white hover:text-gray-400" target="_blank" href="https://www.facebook.com/profile.php?id=61557006988058">
                <svg
            ...
            <a className="mr-6 text-white hover:text-gray-400" href="mailto:sentosakaryaaditamapt@gmail.com">
                <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="16" 
                height="16" 
            ...
            <a className="mr-6 text-white hover:text-gray-400" target="_blank" href="https://www.tiktok.com/@sentosatki">
                <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="16" 
                height="16" 
            ...
            <a className="text-white hover:text-gray-400" target="_blank" href="https://api.whatsapp.com/send?phone=6282298983076">
                <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="16" 
                height="16" 
        ...
        <div className="mx-6 py-10 text-center md:text-left">
            ...
            <div>
                <h6 className="mb-4 flex text-white justify-center font-bold uppercase md:justify-start">Link Terakit</h6>
                <p className="mb-4">
                ...
                <p>
                    <a className="text-gray-400 text-semibold flex items-center justify-center md:justify-start hover:text-gray-300" target="_blank" href="https://klinikmarchsya.com/">
                        <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        width="16" 
                        height="16" 
                        fill="currentColor" 
                        className="bi bi-hospital mr-2" 
                        viewBox="0 0 16 16">
                        ...
                        KLINIK MARCHSYA CILACAP
                    </a>
                </p>
            </div>
            {/* <!-- Contact section --> */}
            <div>
                <h6 className="mb-4 text-white flex justify-center font-bold uppercase md:justify-start">KONTAK</h6>
