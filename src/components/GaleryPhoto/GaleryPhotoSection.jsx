...
const GaleryPhotoSection = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${apiDatabaseUrl}/gallery-photos`)
    .then(response => {
  ...
  const handleDownload = async (photo) => {
    const url = `${apiDatabaseUrl}/uploads/${photo.image_url}`;
  ...
  const handleShare = (url) => {
    const shareUrl = `${apiDatabaseUrl}/uploads/${url}`;
  ...
  return (
    <section className="bg-white py-20 sm:py-18 relative z-10">
                ...
                <div className='px-5 flex flex-col items-center justify-center'>
                    ...
                    {user && user.jabatan.includes('Writter') && (
                      <>
                        ...
                        <button
                          ...
                          className="flex items-center justify-center bg-blue-500 text-white p-3 md:p-4 lg:p-5 rounded-md hover:bg-blue-600 transition duration-150 ease-in-out text-xs md:text-base lg:text-lg"
                        >
                  ...
                  <div className="relative grid gap-4 mb-8">
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:items-start">
                      <img
                        className="h-auto max-w-full rounded-lg lg:w-2/3 mb-5 lg:mb-0"
                        src={`${apiDatabaseUrl}/uploads/${selectedPhoto.image_url}`}
                        ...
                        {filteredPhotosSelected.map((photo, index) => (
                          ...
                          >
                            <div className="rounded-lg w-full h-full overflow-hidden">
                              <img
                                className="h-full max-w-full rounded-lg cursor-pointer transition-transform duration-500 ease-in-out transform hover:scale-105"
                                src={`${apiDatabaseUrl}/uploads/${photo.image_url}`}
                                alt={photo.title}
                              />
      ...
      {modalAddPhoto && (
        <ModalAddPhoto isOpen={modalAddPhoto} closeModal={() => setModalAddPhoto(false)} toast={toast} onLoadPhoto={() => {
          axios
            .get(`${apiDatabaseUrl}/gallery-photos`)
