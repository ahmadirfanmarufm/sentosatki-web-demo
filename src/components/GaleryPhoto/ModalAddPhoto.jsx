...
const ModalAddPhoto = ({ isOpen, closeModal, toast, onLoadPhoto }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${apiDatabaseUrl}/upload/gallery-photos/photo`, formData, {
                headers: {
            ...
            toast.error('Gagal menambahkan foto. Silakan coba lagi.');
        } finally {
...
ModalAddPhoto.propTypes = {
    ...
    onLoadPhoto: PropTypes.func.isRequired,
};
