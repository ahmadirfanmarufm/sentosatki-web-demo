...
// import video2 from '../../assets/welder-traning-1.mp4';
...
const GaleryVideoSection = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${apiDatabaseUrl}/gallery-videos`)
    .then(response => {
    ...
    <section className="bg-white py-20 sm:py-18">
          ...
          {loadingVideos ? (
            <>
              <div className="px-5 flex flex-col items-center justify-center">
                ...
                {/* Skeleton untuk Tombol (khusus Writter) */}
                ...
                {currentVideos.length < 0 ? (
                  ...
                  currentVideos.map((video, index) => (
                    ...
                    >
                      ...
                      >
                        <source src={`${apiDatabaseUrl}/uploads/${video.src}`} type="video/mp4" />
      ...
      {modalAddVideo && (
        <ModalAddVideos isOpen={modalAddVideo} closeModal={() => setModalAddVideo(false)} toast={toast} refreshVideos={() => {
          axios
            .get(`${apiDatabaseUrl}/gallery-videos`)
