...
const ModalEditVideos = ({ isOpen, closeModal, toast, selectedVideoId, refreshVideos }) => {
    ...
    useEffect(() => {
        axios.get(`${apiDatabaseUrl}/gallery-videos/${selectedVideoId}`)
        .then((response) => {
            setTitle(response.data.title);
            setCategory(response.data.category)
            setVideoPreview(`${apiDatabaseUrl}/uploads/${response.data.src}`);
        }).catch((error) => {
            return console.error('Error fetching video:', error);
        }) 
    }, [apiDatabaseUrl, selectedVideoId])
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.put(`${apiDatabaseUrl}/edit/gallery-videos/video/${selectedVideoId}`, formData, {
            headers: {
            ...
            toast.error('Gagal mengubah video. Silakan coba lagi.');
            setLoadingSubmit(false);
        });
    };
...
export default ModalEditVideos;
