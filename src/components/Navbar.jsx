                        ...
                        <ul className="py-2 text-sm text-gray-800 text-left">
                          {user.jabatan === 'Writter' && (
                            <li>
                              <NavLink
                                to="/tambah-berita"
                                className="block px-4 py-2 hover:bg-gray-100 hover:text-primary-400"
                              >
                                Tambahkan Berita
                              </NavLink>
                            </li>
                    ...
                    {user ? (
                      <Popover className="relative">
                        {({ open }) => {
                          ...
                          return (
                            <>
                              <PopoverButton className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-200 transition duration-400 ease-in-out">
                                <img
                                  className="w-8 h-8 me-2 rounded-full"
                                  src={user.image}
                                  alt={`${user.nama} photo`}
