...
const ModalEditNews = ({ selectedNewsId, onClose, refreshNews, isOpen, setOpen }) => {
    ...
    return(
        <Dialog open={isOpen} onClose={setOpen} className="fixed z-50 inset-0 overflow-y-auto flex items-center justify-center px-4">
            <DialogBackdrop
                transition
                className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in"
            />
            <div className='flex items-center justify-center min-h-screen p-4'>
                <DialogPanel transition className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
                    <DialogTitle className="text-2xl text-center font-bold text-primary-secondary-800 px-6 pt-4 uppercase">Edit Berita</DialogTitle>
