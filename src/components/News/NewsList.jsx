...
const NewsList = () => {
  ...
  return (
    <div
      ref={postsListRef}
      className="bg-white py-20 px-4 sm:py-18 relative z-10"
    >
      <div className="mx-auto max-w-7xl items-center justify-center">
        ...
        {loading ? (
          ...
          currentPosts.map((item) => (
            <div
              key={item.id}
              className="max-w-md mx-auto bg-white mt-5 rounded-xl shadow-md overflow-hidden md:max-w-2xl mb-4 transition duration-300 ease-in-out transform hover:scale-105"
            >
              ...
              <Link to={`/berita/${item.id}`} className="md:flex">
                <div className="md:flex-shrink-0">
                  <img
                    ...
                    src={`${apiDatabaseUrl}/uploads/${item.image}`}
                    alt={item.title}
                  />
                </div>
                <div className="p-8">
