...
const AddNewsSection = () => {
    ...
    const onSubmit = (data) => {
        try {
            ...
            formData.append('author_name', user ? user.nama_staff : 'Writer');
                ...
                <div className="max-w-3xl mx-auto px-4 py-1 bg-white shadow-lg rounded-lg">
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" encType="multipart/form-data">
                        <div className="flex flex-col">
                            <label htmlFor="title" className="text-md font-semibold text-gray-800 mb-4">Judul Berita</label>
                            <input
                                id="title"
                                type="text"
                                {...register('title')}
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="category" className="text-md font-semibold text-gray-800 mb-4">Kategori Berita</label>
                            <input
                                id="category"
                                type="text"
                                {...register('category')}
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="image" className="text-md font-semibold text-gray-800 mb-4">Gambar Berita</label>
                            {photoError && (
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="content" className="text-md font-semibold text-gray-800 mb-4">Isi Berita</label>
                            <Editor
                                id="content"
                                apiKey={apiKey}
                                initialValue=""
                        ...
                        <div>
                            <button
                                type="submit"
                                className="w-full py-2.5 text-center text-sm font-medium text-white bg-primary-secondary-800 rounded-lg hover:bg-primary-400 transition duration-400 ease-in-out"
                            >
                                Simpan Berita
                            </button>
                        </div>
