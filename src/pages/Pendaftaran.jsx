...
import ProcedureRegistration from '../components/Pendaftaran/ProcedureRegistration';
import RegistrationPreparation from '../components/Pendaftaran/RegistrationPreparation';
import Headers from '../components/Pendaftaran/Headers';
import DeparturePreperation from '../components/Pendaftaran/DeparturePreperation';

const Pendaftaran = () => {
  const [isModalOpen, setIsModalOpen] = useState(false);

  useEffect(() => {
    document.title = 'PENDAFTARAN - PT. SENTOSAKARYA ADITAMA';
  }, []);
