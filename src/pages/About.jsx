...
import ExplanationCompany from '../components/About/ExplanationCompany';
import VisionAndMissionSection from '../components/About/VisionAndMissionSection';
import CompanyList from '../components/About/CompanyList';
import HistoryCompanySection from '../components/About/HistoryCompanySection';
import WhatsappWidget from '../components/WhatsappWidget';
import CompanyResult from '../components/About/CompanyResult';
import InstructureSection from '../components/About/InstructureSection';

const About = () => {
  const [isModalOpen, setIsModalOpen] = useState(false);

  useEffect(() => {
    document.title = 'TENTANG KAMI - PT. SENTOSAKARYA ADITAMA';
  }, []);
  ...
  return (
    <div className="App">
      ...
      {/* Section Penjelasan Perusahaan */}
      <ExplanationCompany />

      {/* Section Hasil Perusahaan */}
      <CompanyResult />
      ...
      <HistoryCompanySection />

      {/* Section Instruktur Perusahaan */}
      <InstructureSection />
